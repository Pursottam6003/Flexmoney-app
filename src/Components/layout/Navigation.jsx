...
const Logo = () => (
    <Box sx={{ display: "flex", alignItems: "center", textDecoration: 'none' }} component={NavLink} to='/'>
        <Box sx={{ height: 64, mr: 1, padding: 1 }}>
            <img width="55" height="55" src="https://img.icons8.com/external-modern-lines-kalash/64/external-yoga-coronavirus-protective-modern-lines-kalash.png" alt="external-yoga-coronavirus-protective-modern-lines-kalash" />
        </Box>
        <Typography
            variant='h5'
            noWrap
...
const navItems = [
    { url: '/enroll', label: 'Enrollment Form' },
                        ...
                        <Box sx={{ flexGrow: 0 }}>
                            <Tooltip title="Profile">
                                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                                    <Avatar alt="profile name" sx={{ bgcolor: '#4191b7' }}>
                                        <UserIcon />
                                    </Avatar>
                                </IconButton>
                            </Tooltip>
